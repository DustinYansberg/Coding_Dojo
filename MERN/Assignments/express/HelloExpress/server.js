...
// MIDDLEWARE FUNCTIONS -- responsible for providing and parsing the request.body data
...
app.get("/api/users/:id", (req, res) => {
  ...
  const { id } = req.params; // destructure id from req.params (alternatively, const id = req.params.id)
  console.log(users[id]); // assuming this id is the index of the users array we could return one user this way
  res.json(users[id]);
});
