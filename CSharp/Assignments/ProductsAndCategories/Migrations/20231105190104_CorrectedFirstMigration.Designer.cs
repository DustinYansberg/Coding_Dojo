...
namespace ProductsAndCategories.Migrations
{
    ...
    [Migration("20231105190104_CorrectedFirstMigration")]
    partial class CorrectedFirstMigration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProductsAndCategories.Models.Association", b =>
                {
                    b.HasOne("ProductsAndCategories.Models.Category", "Cat")
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProductsAndCategories.Models.Product", "Prod")
                        .WithMany()
